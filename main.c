...
/**
  ...
  * @Project        : freertos
  *
  * Purpose         : RTOS is used to toggle the on-board blue LED at a 250 ms rate. The blinkRed task toggles
  * 				          the on-board red LED at a 125 ms rate, blinkGreen toggles the greenLED at a 75 ms rate, blinkOrange
  * 				          toggles the yellowLED at a 37 ms rate.
  ******************************************************************************
  */
...
/* Definitions for blinkOrange */
osThreadId_t blinkOrangeHandle;
const osThreadAttr_t blinkOrange_attributes = {
  .name = "blinkOrange",
  .priority = (osPriority_t) osPriorityLow,
  .stack_size = 128 * 4
};
...
void StartBlinkOrange(void *argument);
...
int main(void)
{
  ...
  /* creation of blinkOrange */
  blinkOrangeHandle = osThreadNew(StartBlinkOrange, NULL, &blinkOrange_attributes);
...
/* USER CODE BEGIN Header_StartBlinkOrange */
/**
* @brief Function implementing the blinkOrange thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartBlinkOrange */
void StartBlinkOrange(void *argument)
{
  /* USER CODE BEGIN StartBlinkOrange */
  /* Infinite loop */
  for(;;)
  {
  ...
  /* USER CODE END StartBlinkOrange */
}
